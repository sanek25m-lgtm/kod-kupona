...
(function(){
  ...
  if(routes[id])location.replace(CouponI18n.localizeUrl(new URL(routes[id],couponSiteRoot).href));
  else location.replace(CouponI18n.localizeUrl(new URL('blog.html',couponSiteRoot).href));
})();
